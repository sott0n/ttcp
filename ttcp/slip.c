...
static int slip_open (struct netdev *dev, int opt)
{
...
static int slip_close (struct netdev *dev)
{
    struct slip_priv *priv;
...
static void *slip_rx_thread (void *arg)
{
    struct netdev *dev;
    struct slip_priv *priv;
    struct pollfd pfd;
...
static int slip_run (struct netdev *dev)
{
    struct slip_priv *priv;
    int err;
...
static int slip_stop (struct netdev *dev)
{
    struct slip_priv *priv;
...
static ssize_t slip_tx (struct netdev *dev, uint16_t type, const uint8_t *payload, size_t plen, const void *dst)
{
    struct slip_priv *priv;
    uint8_t *p;
